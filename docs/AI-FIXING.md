...
| Cleaning keys out of old Error Log rows (and masking the Error Log queue in Redis) | `optimus/maintenance.py` | `scrub_error_log_secrets`, `mask_error_log_queue`, `purge_ai_error_logs` |
